...
public class LoginActivity extends AppCompatActivity {
    ...
    public class checkLogin extends AsyncTask<String,String,String>
    {
        ...
        protected String doInBackground(String... strings) {
            ...
            if(con == null){
                ...
                try {
                    String sql = "SELECT * FROM user_table WHERE username = '"+usernameLogin.getText()+"' AND password = '"+passwordLogin.getText()+"'";
                    ...
                    if (rs.next()) {
                        ...
                        status.setTextColor(getResources().getColor(R.color.button_color));
    ...
    public Connection establishConnection() {
        ...
        try {
            ...
            connection = DriverManager.getConnection("jdbc:mysql://harmfulplantdatabase.c276elrnqxaz.us-east-2.rds.amazonaws.com:3306/harmfulPlantDB", "admin", "CS407poison");
        } catch (Exception e) {
